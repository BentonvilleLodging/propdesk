...
- REVIEW DATA CAVEAT: reviews.count comes from Guesty's Booking Engine API, which has known, documented gaps in review sync completeness that are not fully understood yet -- treat a count of 0 as "unconfirmed, verify on the live Airbnb listing" rather than confidently asserting the listing has zero reviews. A nonzero count is real and can be trusted normally.
